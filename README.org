...
The safest way for surpassing this obstacle is to use the method described in the next subsection in order to enable access to the pi via ssh using a public key on your computer.
